...
In questi dati l'errore sul centroide in secondi è stato preso interpolando i dati una volta fatta la calibrazione, quindi non tenendo conto degli errori nei parametri
